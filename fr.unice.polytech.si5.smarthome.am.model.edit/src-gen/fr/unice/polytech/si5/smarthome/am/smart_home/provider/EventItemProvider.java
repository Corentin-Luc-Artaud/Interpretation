...
/**
 * This is the item provider adapter for a {@link fr.unice.polytech.si5.smarthome.am.smart_home.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider extends NamedElementItemProvider {
	...
	protected void addActorPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Event_actor_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Event_actor_feature", "_UI_Event_type"),
						SmartHomePackage.Literals.EVENT__ACTOR, true, false, true, null, null, null));
	}
	...
	protected void addActionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Event_action_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Event_action_feature", "_UI_Event_type"),
						SmartHomePackage.Literals.EVENT__ACTION, true, false, true, null, null, null));
	}
