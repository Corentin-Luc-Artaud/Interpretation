 ...
 * </p>
 * <ul>
 *   <li>{@link fr.unice.polytech.si5.smarthome.am.model.impl.SubjectImpl#getAction <em>Action</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubjectImpl extends NamedElementImpl implements Subject {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.SUBJECT;
	}
	...
	public EList<Action> getAction() {
		if (action == null) {
			action = new EObjectContainmentEList<Action>(Action.class, this, ModelPackage.SUBJECT__ACTION);
		}
		return action;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ModelPackage.SUBJECT__ACTION:
