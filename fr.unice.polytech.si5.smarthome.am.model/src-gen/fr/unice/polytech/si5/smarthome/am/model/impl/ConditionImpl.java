 ...
 * </p>
 * <ul>
 *   <li>{@link fr.unice.polytech.si5.smarthome.am.model.impl.ConditionImpl#getEvent <em>Event</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionImpl extends MinimalEObjectImpl.Container implements Condition {
	...
	public NotificationChain basicSetEvent(Event newEvent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ModelPackage.CONDITION__EVENT, oldEvent, newEvent);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newEvent != event) {
			...
			if (event != null)
				msgs = ((InternalEObject) event).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ModelPackage.CONDITION__EVENT, null, msgs);
			if (newEvent != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.CONDITION__EVENT, newEvent, newEvent));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ModelPackage.CONDITION__EVENT:
